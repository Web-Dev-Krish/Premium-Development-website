...
export default function Hero({ settings }: { settings: Record<string, string> }) {
  ...
  return (
    <section
      id="top"
      className="relative flex w-full items-center overflow-hidden pt-[112px] sm:pt-[120px] lg:min-h-[85vh] lg:min-h-[85svh] lg:pt-[80px]"
    >
      ...
      <div className="relative mx-auto grid w-full max-w-[1280px] grid-cols-1 items-start gap-8 px-5 pb-10 pt-6 sm:px-8 sm:gap-10 sm:pb-14 sm:pt-8 lg:grid-cols-12 lg:items-center lg:gap-10 lg:px-10 lg:pt-[60px] lg:pb-12">
